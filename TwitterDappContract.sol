...
interface IProfile {
 ...
 contract Twitter is Ownable{
    uint16 public MAX_TWEET_LENGTH=330;
    ...
    event TweetUnliked(address unliker,address tweetAuthor,uint256 tweetId,uint256 newLikecountt);
    ...
    function createTweet(string memory _tweet) public onlyRegistered {
        ...
        require(bytes(_tweet).length<=MAX_TWEET_LENGTH,"Tweet Length Is Too High");
    ...
    function likeTweet(address author ,uint id) public onlyRegistered {
